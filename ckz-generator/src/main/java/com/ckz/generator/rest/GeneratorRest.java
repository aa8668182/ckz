package com.ckz.generator.rest;

import com.ckz.generator.common.TableResultResponse;
import com.ckz.generator.service.GeneratorService;
...
public class GeneratorRest {
    ...
    public void code(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"bubble-code.zip\"");
