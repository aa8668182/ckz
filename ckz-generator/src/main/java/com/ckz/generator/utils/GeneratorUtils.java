package com.ckz.generator.utils;


import com.ckz.generator.entity.ColumnEntity;
import com.ckz.generator.entity.TableEntity;
...
//        templates.add("template/index.vue.vm");
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        map.put("swaggerDescription", config.getString("description"));
...
*/
        if (template.contains("serviceImpl.java.vm")) {
            return packagePath + "service"+File.separator+"serviceImpl" + File.separator + className + "ServiceImpl.java";
        }
